...
const LayoutComponent = ({ children }: TProps) => {
    return (
        <html lang="hu" className="bg-gray-100">
            <body>
                <Head>
                ...
                <div className="h-full min-h-screen w-full overflow-auto bg-gray-100">
                    <HeaderComponent />
                    <main className="min-h-[calc(100vh-300px)] px-4 md:px-10 lg:px-20 py-10 mx-auto max-w-[1600px]">
                        {children}
                    </main>
                    <div className="bg-gray-200 py-10 flex gap-4 justify-center h-[150px] items-center">
